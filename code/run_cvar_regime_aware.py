...
def run_backtest(returns, regimes, rho):
    ...
    net_returns, turnover_history, cvar_values, weight_history = [], [], [], []
    regime_at_rebalance = []
    result_dates = []
    ...
    return r, turnover_s, cvar_s, weights_df, regime_s
...
if __name__ == "__main__":
    ...
    r, turnover, cvar_est, weights, regime_at_decision = run_backtest(returns, regimes, rho)
